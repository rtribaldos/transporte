...
<%
	List<Documento> listDocumentos = (List<Documento>) request.getAttribute("listFacturas");
    Usuario usuario = (Usuario) request.getAttribute("usuario");
    SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
    String mensaje = (String) request.getAttribute("mensaje");
    if(mensaje == null || "null".equals(mensaje)){
    	mensaje="";
    }
%>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                    	<li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li><a href="/digitalDoc?op=alta&id=<%=usuario.getId()%>">Subir Factura</a></li>
                                <li><a href="/digitalDoc?op=todasFacturas&id=<%=usuario.getId()%>">Ver Todas</a></li>
                                <li><a href="/digitalDoc?op=facturas&id=<%=usuario.getId()%>">&Uacute;ltimo mes</a></li>
                              </ul>
                ...
                <div class="row">
                		...
                		<table id="tabla" class="table table-hover" width="100%">
					      	<thead>
                                   ...
                                   <th><center>Anticipo</center></th>
                                   <th><center>Cancelaci&oacute;n</center></th>
				       ...
				       <%
					        	for(Documento factura: listDocumentos){
					        		String rutaBorra="/digitalDoc?op=borraFactura&id=" + usuario.getId() + "&idFactura=" + factura.getId();
					        		String rutaEnvia="/digitalDoc?op=enviaFactura&id=" + usuario.getId() + "&idFactura=" + factura.getId();
					        		String sEdit="/digitalDoc?op=ediFactura&id=" + usuario.getId() + "&idFactura=" + factura.getId();
					        		String fecha="";
					        		if(factura.getFecha() != null){
					        			fecha = df.format(factura.getFecha());
					        		}
					        		String enviado="NO";
					        		if(factura.isEnviado()){
					        			enviado="SI";
					        		}
					        %>	
					        		<tr>

				       ...
				       <%
				       		if(listAnticipos != null && listAnticipos.size() > 0){
					        	for(Anticipo anticipo: listAnticipos){
					        		if(anticipo.getAcreedor().getEmail()==usuario.getEmail()){
					        ...
					        %>	
						        		<tr>
						        			<td><a href="<%=sEdit%>"><%=anticipo.getAcreedor().getEmpresa()%></a></td>
						        			<td><%=anticipo.getId()%></td>
							                <td><%=fecha%></td>
							                <td><%=anticipo.getAllFacturas()%></td>
						                	<td></td>
						        		</tr>
					        <%
					        			}

...
public class CancelFile implements Serializable{
  /**
	 * 
	 */
...
@PrimaryKey
  ...
  public CancelFile(User owner, BlobKey blob, Date creationTime,
      String contentType, String filename, long size, String title,
      String description, Cancelacion cancelacion, int posicion) {
